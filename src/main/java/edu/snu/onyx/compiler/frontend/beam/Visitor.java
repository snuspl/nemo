 ...
 */
public final class Visitor extends Pipeline.PipelineVisitor.Defaults {
   ...
   */
  public Visitor(final DAGBuilder<IRVertex, IREdge> builder, final PipelineOptions options) {
