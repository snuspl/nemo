...
@EvaluatorSide
@Unit
public final class VortexAggregator {

  private static final Logger LOG = Logger.getLogger(VortexAggregator.class.getName());
  ...
  @Inject
  private VortexAggregator(final MessageChannel messageChannel,
