...
public final class StageBuilder {
  ...
  private void integrityCheck(final Stage stage) {
    ...
    final String firstPlacement = vertices.iterator().next().getStringProperty(ExecutionProperty.Key.ExecutorPlacement);
    ...
    vertices.forEach(irVertex -> {
      if (!irVertex.getStringProperty(ExecutionProperty.Key.ExecutorPlacement).equals(firstPlacement)
