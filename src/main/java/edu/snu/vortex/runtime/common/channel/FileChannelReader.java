...
/**
 * A file channel reader implementation.
 * @param <T> The type of data records that transfer via this channel.
 * */
public class FileChannelReader<T> implements ChannelReader<T> {
  ...
  public FileChannelReader(final String channelId, final String srcTaskId, final String dstTaskId) {
