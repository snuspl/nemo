 ...
 * @param <PhysicalPlan> execution plan to compile the DAG into.
 */
public interface Backend<PhysicalPlan> {
  /**
   ...
   */
  PhysicalPlan compile(DAG<IRVertex, IREdge> dag) throws Exception;
}
