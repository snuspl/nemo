...
//    irDAGBuilder.addVertex(v7);
    ...
    final IREdge e1 = new IREdge(IREdge.Type.OneToOne, v1, v2, null);
    ...
    final IREdge e2 = new IREdge(IREdge.Type.OneToOne, v1, v3, null);
    ...
    final IREdge e3 = new IREdge(IREdge.Type.ScatterGather, v2, v4, null);
    ...
    final IREdge e4 = new IREdge(IREdge.Type.ScatterGather, v3, v5, null);
    ...
    final IREdge e5 = new IREdge(IREdge.Type.OneToOne, v4, v6, null);
    ...
    final IREdge e6 = new IREdge(IREdge.Type.OneToOne, v4, v8, null);
