...
public final class PhysicalPlanTest {
  ...
  public void testSimplePlan() {
    ...
    e.setAttr(Attribute.Key.EdgeChannelDataPlacement, Attribute.Memory);
  ...
  public void testComplexPlan() {
    ...
    e1.setAttr(Attribute.Key.EdgeChannelDataPlacement, Attribute.Local);
    e1.setAttr(Attribute.Key.EdgeChannelTransferPolicy, Attribute.Pull);
    ...
    e2.setAttr(Attribute.Key.EdgeChannelDataPlacement, Attribute.Local);
    e2.setAttr(Attribute.Key.EdgeChannelTransferPolicy, Attribute.Pull);
    ...
    e3.setAttr(Attribute.Key.EdgeChannelDataPlacement, Attribute.Memory);
    e3.setAttr(Attribute.Key.EdgeChannelTransferPolicy, Attribute.Push);
    ...
    e4.setAttr(Attribute.Key.EdgeChannelDataPlacement, Attribute.Memory);
    e4.setAttr(Attribute.Key.EdgeChannelTransferPolicy, Attribute.Push);
    ...
    e5.setAttr(Attribute.Key.EdgeChannelDataPlacement, Attribute.File);
    e5.setAttr(Attribute.Key.EdgeChannelTransferPolicy, Attribute.Pull);
    ...
    e6.setAttr(Attribute.Key.EdgeChannelDataPlacement, Attribute.File);
    e6.setAttr(Attribute.Key.EdgeChannelTransferPolicy, Attribute.Pull);
    ...
    e7.setAttr(Attribute.Key.EdgeChannelDataPlacement, Attribute.Memory);
    e7.setAttr(Attribute.Key.EdgeChannelTransferPolicy, Attribute.Push);
    ...
    e8.setAttr(Attribute.Key.EdgeChannelDataPlacement, Attribute.Local);
    e8.setAttr(Attribute.Key.EdgeChannelTransferPolicy, Attribute.Pull);
