...
public final class RoundRobinSchedulingPolicyTest {
  ...
  public void testNoneContainerType() {
    final TaskGroup A1 = new TaskGroup("A1", "Stage A", 0, null, ExecutorPlacement.NONE);
    final TaskGroup A2 = new TaskGroup("A2", "Stage A", 0, null, ExecutorPlacement.NONE);
    final TaskGroup A3 = new TaskGroup("A3", "Stage A", 0, null, ExecutorPlacement.NONE);
    final TaskGroup A4 = new TaskGroup("A4", "Stage A", 0, null, ExecutorPlacement.NONE);
    final TaskGroup A5 = new TaskGroup("A5", "Stage A", 0, null, ExecutorPlacement.NONE);
    final TaskGroup A6 = new TaskGroup("A6", "Stage A", 0, null, ExecutorPlacement.NONE);
  ...
  public void testSingleCoreTwoTypesOfExecutors() {
    final TaskGroup A1 = new TaskGroup("A1", "Stage A", 0, null, ExecutorPlacement.COMPUTE);
    final TaskGroup A2 = new TaskGroup("A2", "Stage A", 1, null, ExecutorPlacement.COMPUTE);
    final TaskGroup A3 = new TaskGroup("A3", "Stage A", 2, null, ExecutorPlacement.COMPUTE);
    final TaskGroup A4 = new TaskGroup("A4", "Stage A", 3, null, ExecutorPlacement.COMPUTE);
    final TaskGroup A5 = new TaskGroup("A4", "Stage A", 4, null, ExecutorPlacement.COMPUTE);
    final TaskGroup B1 = new TaskGroup("B1", "Stage B", 0, null, ExecutorPlacement.TRANSIENT);
    final TaskGroup B2 = new TaskGroup("B2", "Stage B", 1, null, ExecutorPlacement.TRANSIENT);
    final TaskGroup B3 = new TaskGroup("B3", "Stage B", 2, null, ExecutorPlacement.TRANSIENT);
