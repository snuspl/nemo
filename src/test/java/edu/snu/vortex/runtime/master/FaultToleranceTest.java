...
public final class FaultToleranceTest {
  ...
  public void setUp() {
    ...
    containerManager = new ContainerManager(mock(EvaluatorRequestor.class), mock(MessageEnvironment.class));
...
//  @Test
  ...
  private void removeExecutor(final String failedExecutorId) {
